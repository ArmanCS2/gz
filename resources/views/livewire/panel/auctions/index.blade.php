                    ...
                    <tbody>
                        @forelse($auctions as $auction)
                            <tr>
                                ...
                                <td class="text-muted">{{ number_format($auction->base_price) }} تومان</td>
                                ...
                                <td>
                                    <a href="{{ route('panel.ads.show', $auction) }}" class="btn btn-modern btn-sm" style="background: rgba(0, 240, 255, 0.2); box-shadow: none; padding: 4px 12px;">
