            ...
            <div class="col-lg-8">
                ...
                <div class="glass-card p-4 p-md-5 mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="modern-input w-100 @error('ad_type') border-danger @enderror" 
                    ...
                    <div class="mb-4">
                        ...
                        <div class="modern-select">
                            <select class="modern-input w-100 @error('category_id') border-danger @enderror" wire:model="category_id" style="color: #ffffff !important;">
