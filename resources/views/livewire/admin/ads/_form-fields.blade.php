...
<div class="row g-3 mb-3">
    <div class="col-md-4">
        ...
        <select class="modern-input w-100" wire:model="user_id" style="color: #ffffff !important;">
    ...
    <div class="col-md-4">
        ...
        <select class="modern-input w-100" wire:model="category_id" style="color: #ffffff !important;">
    ...
    <div class="col-md-4">
        ...
        <select class="modern-input w-100" wire:model.live="ad_type" style="color: #ffffff !important;">
...
<div class="row g-3 mb-3">
    <div class="col-md-6">
        ...
        <select class="modern-input w-100" wire:model="type" style="color: #ffffff !important;">
...
<div class="mb-3">
    ...
    <textarea class="modern-input w-100" rows="4" wire:model="description" style="color: #ffffff !important;"></textarea>
...
<div class="row g-3 mb-3">
    <div class="col-md-6">
        ...
        <input type="url" class="modern-input w-100" wire:model="telegram_link" style="color: #ffffff !important;">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="modern-input w-100" wire:model="telegram_id" placeholder="مثال: @mygroup یا -1001234567890" dir="ltr" style="color: #ffffff !important;">
...
<div class="row g-3 mb-3">
    <div class="col-md-6">
        ...
        <input type="text" class="modern-input w-100" wire:model="member_count" pattern="[0-9]*" inputmode="numeric" onkeypress="return event.charCode >= 48 && event.charCode <= 57" style="color: #ffffff !important;">
...
<div class="row g-3 mb-3">
    <div class="col-md-6">
        ...
        <input type="text" class="modern-input w-100" wire:model="instagram_followers" pattern="[0-9]*" style="color: #ffffff !important;">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="modern-input w-100" wire:model="instagram_category" style="color: #ffffff !important;">
...
<div class="row g-3 mb-3">
    <div class="col-md-6">
        ...
        <input type="text" class="modern-input w-100" wire:model="instagram_engagement_rate" style="color: #ffffff !important;">
...
<div class="row g-3 mb-3">
    <div class="col-md-6">
        ...
        <input type="url" class="modern-input w-100" wire:model="website_url" dir="ltr" style="color: #ffffff !important;">
    ...
    <div class="col-md-6">
        ...
        <select class="modern-input w-100" wire:model="website_type" style="color: #ffffff !important;">
...
<div class="row g-3 mb-3">
    <div class="col-md-6">
        ...
        <input type="text" class="modern-input w-100" wire:model="website_monthly_visits" pattern="[0-9]*" style="color: #ffffff !important;">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="modern-input w-100" wire:model="website_monthly_income" dir="ltr" style="color: #ffffff !important;">
...
<div class="row g-3 mb-3">
    <div class="col-md-12">
        ...
        <input type="text" class="modern-input w-100" wire:model="website_tech" style="color: #ffffff !important;">
...
<div class="row g-3 mb-3">
    <div class="col-md-8">
        ...
        <input type="text" class="modern-input w-100" wire:model="domain_name" dir="ltr" style="color: #ffffff !important;">
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="modern-input w-100" wire:model="domain_extension" dir="ltr" style="color: #ffffff !important;">
...
<div class="row g-3 mb-3">
    <div class="col-md-6">
        ...
        <input type="text" data-jdp class="modern-input w-100" wire:model.blur="domain_expire_date" placeholder="انتخاب تاریخ شمسی" style="color: #ffffff !important;">
...
<div class="row g-3 mb-3">
    <div class="col-md-6">
        ...
        <input type="text" class="modern-input w-100" wire:model="youtube_subscribers" pattern="[0-9]*" style="color: #ffffff !important;">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="modern-input w-100" wire:model="youtube_watch_hours" pattern="[0-9]*" style="color: #ffffff !important;">
...
<div class="row g-3 mb-3">
    <div class="col-md-6">
        ...
        <input type="text" class="modern-input w-100" wire:model="construction_year" pattern="[0-9]*" inputmode="numeric" onkeypress="return event.charCode >= 48 && event.charCode <= 57" placeholder="مثال: 1400 یا 2021" style="color: #ffffff !important;">
    ...
    <div class="col-md-6">
        ...
        <select class="modern-input w-100" wire:model="construction_year_calendar" style="color: #ffffff !important;">
...
<div class="row g-3 mb-3">
    @if($type === 'normal')
        <div class="col-md-6">
            ...
            <input type="text" class="modern-input w-100" wire:model="price" pattern="[0-9]*\.?[0-9]*" inputmode="decimal" onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46" style="color: #ffffff !important;">
    ...
    @else
        <div class="col-md-4">
            ...
            <input type="text" class="modern-input w-100" wire:model="base_price" pattern="[0-9]*\.?[0-9]*" inputmode="decimal" onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46" style="color: #ffffff !important;">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="modern-input w-100" wire:model="current_bid" pattern="[0-9]*\.?[0-9]*" inputmode="decimal" onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46" style="color: #ffffff !important;">
        ...
        <div class="col-md-4">
            ...
            <input type="text" data-jdp class="modern-input w-100" wire:model.blur="auction_end_time" placeholder="انتخاب تاریخ شمسی" style="color: #ffffff !important;">
...
<div class="row g-3 mb-3">
    <div class="col-md-4">
        ...
        <select class="modern-input w-100" wire:model="status" style="color: #ffffff !important;">
    ...
    <div class="col-md-4">
        ...
        <input type="text" data-jdp class="modern-input w-100" wire:model.blur="expire_at" placeholder="انتخاب تاریخ شمسی" style="color: #ffffff !important;">
