                ...
                <div class="glass-card p-4 p-md-5 mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="modern-select">
                            <select class="modern-input w-100 @error('category') border-danger @enderror" wire:model="category" style="color: #ffffff !important;">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="modern-input w-100 @error('ad_type') border-danger @enderror" wire:model.live="ad_type" style="color: #ffffff !important;">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="modern-input w-100 @error('website_type') border-danger @enderror" wire:model="website_type" style="color: #ffffff !important;">
