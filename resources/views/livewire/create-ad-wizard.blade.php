<div class="container-fluid px-3 px-md-5">
            ...
            <div class="col-lg-8">
                ...
                <div class="glass-card p-4 p-md-5 mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" 
                               ...
                               placeholder="مثال: گروه تلگرام فروش محصولات" 
                               wire:model="title"
                    ...
                    <!-- Category -->
                    <div class="mb-4">
                        <label class="form-label mb-2 d-block fw-semibold" for="wizard_category" style="color: #ffffff; font-size: 15px;">
                            <i class="bi bi-tags me-1" style="color: #00f0ff;"></i> دسته‌بندی
                        </label>
                        <div class="modern-select">
                            <select id="wizard_category" class="modern-input w-100 @error('category') border-danger @enderror" wire:model="category" style="color: #ffffff !important;">
                    ...
                    <!-- Ad Type -->
                    <div class="mb-4">
                        <label class="form-label mb-2 d-block fw-semibold" for="wizard_ad_type" style="color: #ffffff; font-size: 15px;">
                            <i class="bi bi-tag me-1" style="color: #00f0ff;"></i> نوع آگهی <span class="text-danger">*</span>
                        </label>
                        <select id="wizard_ad_type" class="modern-input w-100 @error('ad_type') border-danger @enderror" wire:model.live="ad_type" style="color: #ffffff !important;">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label mb-2 d-block fw-semibold" for="telegram-input" style="color: #ffffff; font-size: 15px;">
                        ...
                        <div class="col-md-6">
                            <label class="form-label mb-2 d-block fw-semibold" for="telegram-id-input" style="color: #ffffff; font-size: 15px;">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label mb-2 d-block fw-semibold" for="members-input" style="color: #ffffff; font-size: 15px;">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label mb-2 d-block fw-semibold" for="wizard_instagram_followers" style="color: #ffffff; font-size: 15px;">
                                <i class="bi bi-people me-1" style="color: #00f0ff;"></i> تعداد فالوور <span class="text-danger">*</span>
                            </label>
                            <input type="text" 
                                   id="wizard_instagram_followers"
                        ...
                        <div class="col-md-6">
                            <label class="form-label mb-2 d-block fw-semibold" for="wizard_instagram_category" style="color: #ffffff; font-size: 15px;">
                                <i class="bi bi-tags me-1" style="color: #00f0ff;"></i> دسته‌بندی <span class="text-danger">*</span>
                            </label>
                            <input type="text" 
                                   id="wizard_instagram_category"
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label mb-2 d-block fw-semibold" for="wizard_instagram_engagement_rate" style="color: #ffffff; font-size: 15px;">
                                <i class="bi bi-graph-up me-1" style="color: #00f0ff;"></i> نرخ تعامل (درصد)
                            </label>
                            <input type="text" 
                                   id="wizard_instagram_engagement_rate"
                        ...
                        <div class="col-md-6">
                            <div class="form-check form-switch mt-4">
                                ...
                                <label class="form-check-label" for="instagram_monetized" style="color: #ffffff;">مونیتایز شده</label>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label mb-2 d-block fw-semibold" for="wizard_website_url" style="color: #ffffff; font-size: 15px;">
                                <i class="bi bi-link-45deg me-1" style="color: #00f0ff;"></i> آدرس سایت <span class="text-danger">*</span>
                            </label>
                            <input type="url" 
                                   id="wizard_website_url"
                        ...
                        <div class="col-md-6">
                            <label class="form-label mb-2 d-block fw-semibold" for="wizard_website_type" style="color: #ffffff; font-size: 15px;">
                                <i class="bi bi-tags me-1" style="color: #00f0ff;"></i> نوع سایت <span class="text-danger">*</span>
                            </label>
                            <select id="wizard_website_type" class="modern-input w-100 @error('website_type') border-danger @enderror" wire:model="website_type" style="color: #ffffff !important;">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label mb-2 d-block fw-semibold" for="wizard_website_monthly_visits" style="color: #ffffff; font-size: 15px;">
                                <i class="bi bi-eye me-1" style="color: #00f0ff;"></i> بازدید ماهانه <span class="text-danger">*</span>
                            </label>
                            <input type="text" 
                                   id="wizard_website_monthly_visits"
                        ...
                        <div class="col-md-6">
                            <label class="form-label mb-2 d-block fw-semibold" for="wizard_website_monthly_income" style="color: #ffffff; font-size: 15px;">
                                <i class="bi bi-cash-coin me-1" style="color: #00f0ff;"></i> درآمد ماهانه (تومان)
                            </label>
                            <input type="text" 
                                   id="wizard_website_monthly_income"
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            <label class="form-label mb-2 d-block fw-semibold" for="wizard_website_tech" style="color: #ffffff; font-size: 15px;">
                                <i class="bi bi-code-slash me-1" style="color: #00f0ff;"></i> تکنولوژی استفاده شده
                            </label>
                            <input type="text" 
                                   id="wizard_website_tech"
                    ...
                    <div class="row g-3">
                        <div class="col-md-8">
                            <label class="form-label mb-2 d-block fw-semibold" for="wizard_domain_name" style="color: #ffffff; font-size: 15px;">
                                <i class="bi bi-globe me-1" style="color: #00f0ff;"></i> نام دامنه <span class="text-danger">*</span>
                            </label>
                            <input type="text" 
                                   id="wizard_domain_name"
                        ...
                        <div class="col-md-4">
                            <label class="form-label mb-2 d-block fw-semibold" for="wizard_domain_extension" style="color: #ffffff; font-size: 15px;">
                                <i class="bi bi-dot me-1" style="color: #00f0ff;"></i> پسوند <span class="text-danger">*</span>
                            </label>
                            <input type="text" 
                                   id="wizard_domain_extension"
                                   class="modern-input w-100 @error('domain_extension') border-danger @enderror" 
                                   placeholder="مثال: .com" 
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label mb-2 d-block fw-semibold" for="wizard_youtube_subscribers" style="color: #ffffff; font-size: 15px;">
                                <i class="bi bi-people me-1" style="color: #00f0ff;"></i> تعداد مشترک <span class="text-danger">*</span>
                            </label>
                            <input type="text" 
                                   id="wizard_youtube_subscribers"
                        ...
                        <div class="col-md-6">
                            <label class="form-label mb-2 d-block fw-semibold" for="wizard_youtube_watch_hours" style="color: #ffffff; font-size: 15px;">
                                <i class="bi bi-clock me-1" style="color: #00f0ff;"></i> ساعت تماشا <span class="text-danger">*</span>
                            </label>
                            <input type="text" 
                                   id="wizard_youtube_watch_hours"
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-check form-switch mt-4">
                                ...
                                <label class="form-check-label" for="youtube_monetized" style="color: #ffffff;">مونیتایز شده</label>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="row g-3 mt-0">
                        <div class="col-md-6">
                            <label class="form-label mb-2 d-block fw-semibold" for="construction-year-input" style="color: #ffffff; font-size: 15px;">
                        ...
                        <div class="col-md-6">
                            <label class="form-label mb-2 d-block fw-semibold" for="wizard_construction_year_calendar" style="color: #ffffff; font-size: 15px;">
                                <i class="bi bi-calendar-check me-1" style="color: #00f0ff;"></i> نوع تقویم
                            </label>
                            <select id="wizard_construction_year_calendar" class="modern-input w-100 @error('construction_year_calendar') border-danger @enderror" 
                ...
                <div class="glass-card p-4 p-md-5 mb-4">
                    ...
                    @if($type === 'normal')
                        <!-- Normal Price -->
                        <div class="mb-4">
                            <label class="form-label mb-2 d-block fw-semibold" for="wizard_price" style="color: #ffffff; font-size: 15px;">
                    ...
                    @else
                        <!-- Auction Base Price -->
                        <div class="mb-4">
                            <label class="form-label mb-2 d-block fw-semibold" for="wizard_base_price" style="color: #ffffff; font-size: 15px;">
                                <i class="bi bi-cash-coin me-1" style="color: #b026ff;"></i> قیمت پایه مزایده (تومان) <span class="text-danger">*</span>
                            </label>
                            <div class="d-flex align-items-center gap-3">
                                <input type="text" 
                                       id="wizard_base_price"
                ...
                <div class="glass-card p-4 p-md-5 mb-4">
                    ...
                    <div class="glass-card p-4 mb-4" style="background: rgba(255, 215, 0, 0.1); border-color: rgba(255, 215, 0, 0.3);">
                        <div class="row g-4">
                            <div class="col-md-6">
                                <label class="form-label mb-2 d-block fw-semibold" for="wizard_payment_days" style="color: #ffffff; font-size: 15px;">
                                    <i class="bi bi-calendar-range me-1" style="color: #ffd700;"></i> تعداد روزهای نمایش آگهی
                                </label>
                                <input type="text" 
                                       id="wizard_payment_days"
    ...
    <script>
        ...
        window.initJalaliDatePicker = function() {
            // Wait for jalaliDatepicker to be loaded (it's loaded with defer)
            ...
            // Remove data-jdp-initialized attribute first to allow re-initialization when ad_type changes
            document.querySelectorAll('input[data-jdp]').forEach(input => {
                // Remove the attribute to allow re-initialization
        ...
        // Wait for both DOM and jalaliDatepicker to be ready
        function waitForJalaliDatepicker() {
            if (typeof jalaliDatepicker !== 'undefined') {
                window.initJalaliDatePicker();
            } else {
                setTimeout(waitForJalaliDatepicker, 100);
            }
        }

        document.addEventListener('livewire:init', () => {
            // Wait for jalaliDatepicker to load before initializing
